import { e as createAstro, f as createComponent, k as renderComponent, r as renderTemplate, m as maybeRenderHead } from '../../chunks/astro/server_DonqQ8u2.mjs';
...
async function getStaticPaths() {
  try {
    const { getProducerPlaylist } = await import('../../chunks/appleMusic_D5Nlofx2.mjs');
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "RootLayout", $$RootLayout, { "title": `${track.attributes.name} - Case Study - Shawn Papineau` }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="min-h-screen bg-gradient-to-br from-moody-900 via-moody-800 to-moody-900"> ${renderComponent($$result2, "TrackCaseStudy", TrackCaseStudy, { "track": track, "client:load": true, "client:component-hydration": "load", "client:component-path": "/Users/shawnpapineau/Developer/SPAP/personal-brand-portfolio/astro-client/src/components/react/TrackCaseStudy", "client:component-export": "default" })} </main> ` })}`;
