import { f as createComponent, m as maybeRenderHead, r as renderTemplate, e as createAstro, l as renderScript, u as unescapeHTML, h as addAttribute, n as renderSlot, k as renderComponent, o as renderHead } from './astro/server_DonqQ8u2.mjs';
/* empty css                           */
...
const $$RootLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(['<html lang="en" class="scroll-smooth" data-astro-cid-mdysn4oi> <head><script async src="https://www.googletagmanager.com/gtag/js?id=G-K2Q1L3E4DB"><\/script>', '<meta charset="utf-8"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="manifest" href="/manifest.json"><meta name="generator" content="Astro">', "<!-- Google Analytics -->", "<!-- Performance Optimizer -->", '<!-- Google Fonts - Edgy Typefaces --><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400;700;900&family=Space+Grotesk:wght@300;400;500;600;700&family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">', '</head> <!-- Google tag (gtag.js) --> <body class="bg-moody-900 text-moody-100 font-body antialiased overflow-x-hidden" data-astro-cid-mdysn4oi> ', ' <!-- Gradient Background --> <div class="fixed inset-0 bg-gradient-to-br from-moody-900 via-moody-800 to-warm-900/20 pointer-events-none" data-astro-cid-mdysn4oi></div> <!-- Animated Background Elements --> <div class="fixed inset-0 overflow-hidden pointer-events-none" data-astro-cid-mdysn4oi> <div class="absolute top-20 left-10 w-72 h-72 bg-warm-500/10 rounded-full blur-3xl animate-float" data-astro-cid-mdysn4oi></div> <div class="absolute bottom-20 right-10 w-96 h-96 bg-warm-600/5 rounded-full blur-3xl animate-float" style="animation-delay: -3s;" data-astro-cid-mdysn4oi></div> <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-warm-400/5 rounded-full blur-3xl animate-pulse-slow" data-astro-cid-mdysn4oi></div> </div> <!-- Main Content --> <div class="relative z-10" data-astro-cid-mdysn4oi> ', ' </div> <footer class="py-8 px-4 sm:px-6 lg:px-8 border-t border-warm-500/20 z-30" data-astro-cid-mdysn4oi> <div class="max-w-7xl mx-auto text-center" data-astro-cid-mdysn4oi> <p class="font-body text-moody-400" data-astro-cid-mdysn4oi>\n\xA9 2024 Shawn Papineau. Crafted with passion and precision.\n</p> </div> </footer> <!-- Custom Scrollbar -->  </body> </html>'])), renderScript($$result, "/Users/shawnpapineau/Developer/SPAP/personal-brand-portfolio/astro-client/src/layouts/RootLayout.astro?astro&type=script&index=0&lang.ts"), renderComponent($$result, "SEO", $$SEO, { "title": title, "description": description, "keywords": keywords, "image": image, "url": url, "type": type, "author": author, "publishedTime": publishedTime, "modifiedTime": modifiedTime, "section": section, "tags": tags, "canonical": canonical, "noindex": noindex, "nofollow": nofollow, "data-astro-cid-mdysn4oi": true }), renderComponent($$result, "GoogleAnalytics", $$GoogleAnalytics, { "data-astro-cid-mdysn4oi": true }), renderComponent($$result, "PerformanceOptimizer", $$PerformanceOptimizer, { "data-astro-cid-mdysn4oi": true }), renderHead(), renderComponent($$result, "Header", $$Header, { "data-astro-cid-mdysn4oi": true }), renderSlot($$result, $$slots["default"]));
